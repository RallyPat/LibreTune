...
fn test_include_basic() {
    ...
    create_temp_ini(&dir, "included.ini", r#"
[Constants]
    page = 1
...
"#);
    ...
    let main_path = create_temp_ini(&dir, "main.ini", r#"
[MegaTune]
...
"#);
    ...
    assert!(def.constants.contains_key("mainConst"), "Should have mainConst from main.ini");
    assert!(def.constants.contains_key("includedConst"), "Should have includedConst from included.ini");
...
fn test_include_nested() {
    ...
    create_temp_ini(&dir, "level2.ini", r#"
[Constants]
    page = 1
    level2Const = scalar, U08, 20, "", 1, 0, 0, 255, 0
"#);
    
    create_temp_ini(&dir, "level1.ini", r#"
#include "level2.ini"
...
fn test_include_circular_detection() {
    ...
    create_temp_ini(&dir, "a.ini", r#"
[Constants]
    page = 1
#include "b.ini"
"#);
    
    create_temp_ini(&dir, "b.ini", r#"
[Constants]
    page = 1
#include "a.ini"
"#);
    ...
    assert!(err.to_string().contains("circular"), "Error should mention circular reference");
}
...
fn test_include_conditional() {
    ...
    create_temp_ini(&dir, "extra.ini", r#"
[Constants]
    page = 1
...
"#);
    ...
    assert!(def.constants.contains_key("mainConst"));
    assert!(def.constants.contains_key("extraConst"), "extraConst should be included");
}
...
"#);
    ...
    assert!(def.constants.contains_key("mainConst"));
    assert!(!def.constants.contains_key("extraConst"), "extraConst should NOT be included");
}
...
fn test_include_subdirectory() {
    ...
    fs::write(subdir.join("sub.ini"), r#"
[Constants]
    page = 1
...
"#);
    ...
    assert!(def.constants.contains_key("mainConst"));
    assert!(def.constants.contains_key("subConst"), "Should include from subdirectory");
}
