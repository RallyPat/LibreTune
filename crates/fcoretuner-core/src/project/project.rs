...
impl Project {
    ...
    /// Import a TunerStudio project into FCoreTuner format
    ///
    /// Reads project.properties, vehicle.properties, and copies relevant files.
    /// Creates a new FCoreTuner project in the projects directory.
    ///
    /// # Arguments
    ...
    pub fn import_tunerstudio<P: AsRef<Path>>(
        ...
        // Create the new FCoreTuner project
...
mod tests {
    ...
    fn test_project_creation() {
        let temp = temp_dir().join("fcoretuner_test_projects");
