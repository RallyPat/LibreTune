package io.fcoretuner.pluginhost;
 ...
 * Settings are stored in memory and synced to FCoreTuner via notifications.
 */
public class UiSettingServerImpl implements UiSettingServer {
    ...
    /**
     * Set available table names (called from FCoreTuner).
     */
    ...
    /**
     * Set available curve names (called from FCoreTuner).
     */
    ...
    /**
     * Set available gauge names (called from FCoreTuner).
     */
    ...
    /**
     * Set available dialog names (called from FCoreTuner).
     */
    ...
    /**
     * Update settings from FCoreTuner.
     */
