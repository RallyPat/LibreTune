...
/**
 * FCoreTuner implementation of ControllerAccess for plugin compatibility.
 */
public class ControllerAccessImpl extends ControllerAccess {
    ...
    // Cached realtime data from FCoreTuner
    ...
    public boolean isOnline() {
        return true; // FCoreTuner manages connection state
    }
    
    /**
     * Update realtime data from FCoreTuner.
     */
    ...
    /**
     * Get all parameter names (requests from FCoreTuner).
     */
